var json  = [{
	"text": "<p>As comemorações terminaram e vocês está a caminho de casa, em uma vila próxima, quando ocorre um encontro inesperado; um viajante está caído à beira da estrada. Suas roupas estã sujas e rasgadas, embora pareçam ter sido de luxuosas outrora. E ele está sendo cruelmente espancado por um bando de ladrões. Cinco deles.</p><p>Quantidade pequena demais para fazer frente a um guerreiro de Hedryl.</p><p>A luta é breve. Os assaltantes que não morreram fogem da fúria de sua lâmina. você devolve a Espada Sagrada à bainnha e presta socorro ao viajante caído. Quando ele se recupera, diz que está procurando ajuda para sua vila - que está sendo aterrorizada por um dragão. Um dragão vermelho.</p><p>Um dragão vermelho? Pelo visto, o deus Hedryl está colocando você no caminho da justiça mais cedo do  que esperava. Sua missão exige a morte de uma criatura tão maligna. A vila ameaçada fica a dois dias de viagem, e você segue para lá</p><p>A viagem até a vila não é longa, mas tem sua dose de perigo. Logo você alcança as proximidades do Pântano da Agonia. lugar habitado por todo tipo de horrores rastejantes.</p><p>Contornar essa região maldita é mais seguro, mas levaria tempo demais - tempo que pode custar a vida de mais vítimas do dragão. Segui através do pântano, por outro lado, é um convite para saciar o apetite dos predadores que infestam suas águas</p>",
	"origin": "1 e 20",
	"id": 0,
	"options": [{
		"text": "<li><a href='#'>Agir com cautela e dar a volta ?</a></li>",
		"goto": 1
	}, {
		"text": "<li><a href='#'>Passar pelo Pântano da Agonia ?</a></li>",
		"goto": 2
	}]
},{
	"text": "<p>você decide ser cauteloso e continua no caminho, à margem do pântano, seguindo até perto do anoitecer quando pára e improvisa um acampamento, acendendo uma fogueira para  manter-se quente e seguro.</p><p>Depois de algum tempo, quando a escuridão é intensa, ruídos estranhos chegam do pântano. Sua mão voa para o punho da espada. Das sombras começam a surgir seis criaturas corpulentas, escamosas, com olhos amarelos e línguas silvantes.</p><p>São homens-lagartos, armados com espadas curtas, e parece que procuram briga</p>",
	"origin": "10",
	"id": 1,
	"options": [{
	...
	"text": "<p>Fugir seria tolice. Seis homens-lagartos são uma ameça séria para um aventureiro qualquer, é verdade... mas você não é um qualquer! Éum guerreiro de Hedryl, empunhando uma Espada Sagrada. Contra você esses asquerosos predadores do pântano são menos que NADA!</p><p>As abominações escamosas tombam uma a uma sob o ataque de sua lâmina. Tenso demais para dormir, você decide que o Pântano da Agonia não é seguro para um cochilo - e resolve seguir viagem.</p><p>Após ter se distanciado do Pântano da Agonia, você descansa um pouco. Ora aos deuses, afradecendo sua bondade por permitir que continue vivo - e, em resposta, os pouco ferimento que recebeu durante a luta curam-se como que por mágica.</p><p>Mágica dos deuses, você sabe.</p><p>Ao amanhecer você resolve comer algo e descansar um pouco antes de continuar a viagem. Afinal, sua armadura é de ferro, mas você não</p><p>A viagem continua calma, sem mais nenhum problema relevante, e permanece assim até o meio da tarde. Em certo ponto o caminho se bifurca.</p>",
	"origin": "35",
	"id": 3,
	"options": [{
		"text": "<li><a href='#'>Ir para a direita.</a></li>",
		"goto": 7
	}, {
		"text": "<li><a href='#'>Ir para a esqueda.</a></li>",
		"goto": 8
	}]
},{
	"text": "<p>você se deixa dominar pelo medo e vira-se para fugir.<br>Antes que consiga dar dois passos, contudo, sente uma picada no ombro. Os homens-lagartos estão disparando dardos com zarabatanas, e um deles atingiu-o</p><p>Depois de uma curta corrida, você deixa seus lemntos perseguidores para trás - mas percebe que seu corpo esta ardendo em febre intensa. O dardo estava envenenado, e mesmo sua saúde excepcional não consegue anular a forte toxina que paralisa seu corpo. Ao final de uma hora, todos os seus músculos estão imóveis exceto o coração, que ainda pulsa com dificuldade quando os homens-lagartos finalmente aparecem.</p><p>É... você vai ser servido com batatas no jantar!</p><h3>Fim.</h3>",
	"origin": "32",
	"id": 4 ,
	"options": [{
	...
	"text": "<p>Ao olhar para aqueles horrendos monstros, você se lembra de ter ouvido algo sobre os scrags: eles, como os trolls, temem, fogo. você procura mantê-los afastados com a tocha enquanto procura por um frasco de óleo em sua mochila. Quando encontra, joga-a com toda a sua força contra um dos scrags. Ela se quebra, cobrindo a criatura com óleo inflamável, e basta um toque de sua tocha para fazê-lo arder em chamas</p><p>você se vira para enfrentar o outro scrag, apenas para notar que este foge para a escuridão. Tendo a tocha em uma mão e outro frasco de óleo na outra, você segue viagem.</p><p>você continua seguindo, agora mais atento a sons peculiares, até deixar o pântano. Quando está longe, aproveita para descansar um pouco e aliviar suas dores. Já é de manhã e você está longe do Pântano da Agonia.</p><p>A viagem continua calma, sem mais nenhum problema relevante, e permanece assim até o meio da tarde. Em certo ponto do caminho se bifurca</p>",
	"origin": "5,33,7",
	"id": 5 ,
	"options": [{
		"text": "<li><a href='#'>Ir para a direita.</a></li>",
	...
	"text": "<p>Além de garras e presas temíveis, os scrags, possuem a capacidade de regenerar ferimentos muito rapidamente; suas feridas começam a cicatrizar logo depois de abertas, e membros amputados crescem de novo inteiramente. Mesmo sua Espada Sagrada pode não ser suficiente para matar tais monstros.</p><p>você acha mais sensato fugir através do pântano.</p><p>Quando você julgava ter deixado os scrags para trás, um deles salta sobre você, agarrando-o pelas costas. você é tomado de horror e tenta livrar-se a todo custo, Seu espadanar desesperado termina por soltá-lo das garras do monstro, e você consegue correr para longe - tendo apenas um arranhão no pescoço. Bem não há problema: guerreiros de Hedryl são imunes a doenças vulgares, e scrags não transmitem qualquer tipo de praga mágica, como licantropia ou coisa parecida.</p><p>você continua seguindo, agora mais atento a sons peculiares, até deixar o pântano. Quando está longe, aproveita para descansar um pouco e aliviar suas dores. Já é de manhã e você está longe do Pântano da Agonia.</p><p>A viagem continua calma, sem mais nenhum problema relevante, e permanece assim até o meio da tarde. Em certo ponto do caminho se bifurca</p>",
	"origin": "15,25,33,7",
	"id": 6 ,
	"options": [{
		"text": "<li><a href='#'>Ir para a direita.</a></li>",
	...
	"text": "<p>A jornada pelo caminho da direita é tranquila. Uma estalagem surge ao longe, e você apressa o passo - imaginando quão bom será comer uma refeição quente e dormir em uma cama macia. você consegue um quarto, devora um grande pedaço de carne (felizmente sua ordem não exige dieta vegetariana), lava-se e vai dormir.</p><p>Pela manhã, após um rápido desjejum, você retoma o caminho da vila de Terum. A estrada birfuca-se novamente logo adiante: o caminho da direita segue sobre uma montanha, e o da esquerda passa por um vale que contorna a montanha.</p>",
	"origin": "27",
	"id": 7 ,
	"options": [{
	...
	"text": "<p>O caminho da esquerda leva você a um gingantesco desfiladeiro. A fenda é enorme, e não há como chegar ao outro lado. Irritado pela perda de tempo, você volta para a encruzilhada e toma o caminho da direita</p>",
	"origin": "16",
	"id": 8 ,
	"options": [{
	...
	"text": "<p>O sol castiga você enquanto cruza o vale, fazendo-o pensar se não seria preferível ir pela montanha. A dúvida transforma-se em certeza quando, ápos algumas horas, você penetra em um antigo campo de batalha: uma clareira cheia de armaduras enferrujadas, armas quebradas e ossos humanos</p><p>você reza pelas almas desses guerreiros enquanto atravessa a clareira. Em certo mo, coisas movem-se no chão. A princípio você pensa se tratar de bichos escondidos nas carcaças, mas então você percebe: são as próprias carcaças. Os mortos estão se levantando para atacar você.</p>",
	"origin": "36",
	"id": 10 ,
	"options": [{
		"text": "<li><a href='#'>você foi ferido no pescoço anteriormente ?</a></li>",
		"goto": 12
	}, {
		"text": "<li><a href='#'>você não foi ferido no pescoço anteriormente ?</a></li>",
		"goto": 13
	}]
},{
	"text": "<p>Julgando que o risco da escalada vale a pena, você avança. Sobe devagar, procurando saliêcias firmes para se apoiar, sofrendo com o peso da armadura. No caminho até o topo, o inesperado acontece: sua bolsa de moedas cai, e rola até alguns metros abaixo de onde você está.</p>",
	"origin": "14",
	"id": 11 ,
	"options": [{
		"text": "<li><a href='#'>Voltar e recuperar a bolsa.</a></li>",
		"goto": 14
	}, {
		"text": "<li><a href='#'>Esquecer e continuar escalando.</a></li>",
		"goto": 15
	}]
},{
	"text": "<p>você leva a mão ao pescoço, em busca de seu símbolo sagrado-o pequeno medalhão que poderá canaliza sua fé e esconjurar os mortos-vivos. Não encontra: deve ter sido arrancado no momento em que o scrag agarrou-o no pesco.</p><p>Agora só resta lutar. À medida que os mortos-vivos se aproximam, você começa a brandir sua espada. A lâminasagrada transforma-os em pedaços facilmente-mas, para cada um que cai, dez outros se levantam-se. A luta incessante esgota suas forças, e os cadáveres acabam alcançando-o. você sucumbe ao ataque de suas garras.</p><h3>Fim.</h3>",
	"origin": "2",
	"id": 12 ,
	"options": [{
		"text": "<li><a href='#'>Recomeçar</a></li>",
	...
	"text": "<p>Com a aproximação dos putrefatos mortos-vivos, você busca o pequeno medalhão de prata em formato de espada, o símbolo da justiça de Hedryl. Com uma prece, vocêpede a seu deus  que afaste as criaturas malditas.</p><p>Os cadáveres parecem espantados com a visão da pequena espada. Alguns emitem gritos sufocados e desmancham-se em pó, enquanto outros somem na escuridão. Agora é seguro prosseguir.</p><p>Sua viagem é interrompida por um rio com cerca de 50 metros de largura. Sua armadura proíbe qualquer tentativa de cruzá-lo a nado. Há uma ponte nas proximidades, mas ela parece velha e fraca demais para suportar um guerreiro pesadamente equipado.</p><p>Enquanto você examina a ponte, uma pequena jangada aproxima-se. Seu ocupante é um homem de pele escura que tira o chapéu de palha e o comprimenta-o com um sorriso de dentes falhos:</p><p>- Não se arrisque  nessa ponte apodrecida senhor. Por duas peças de cobre, posso levá-lo à outra margem em minha jangada.</p>",
	"origin": "12,34",
	"id": 13 ,
	"options": [{
		"text": "<li><a href='#'>Aceitar ?</a></li>",
		"goto": 16
	}, {
		"text": "<li><a href='#'>Regeitar ?</a></li>",
		"goto": 17
	}]
},{
	"text": "<p>Na tentativa de recuperar seu dinheiro, você experimenta descer um pouco a encosta - quando olha para baixo e descobre que é uma queda imensa! Não se trata apenas da distância entre você e a trilha, porque você está em um lugar diferente e corre o risco de rolar centenas de metros montanha abaixo. O risco é maior do que supunha.</p>",
	"origin": "6",
	"id": 14 ,
	"options": [{
		"text": "<li><a href='#'>Desistir ?</a></li>",
		"goto": 15
	}, {
		"text": "<li><a href='#'>Continuar tentando ?</a></li>",
		"goto": 19
	}]
},{
	...
	"id": 16 ,
	"options": [{
		"text": "<li><a href='#'>Entregar todo o dinheiro.</a></li>",
		"goto": 18
	}, {
		"text": "<li><a href='#'>Recusar ?</a></li>",
		"goto": 20
	}]
},{
